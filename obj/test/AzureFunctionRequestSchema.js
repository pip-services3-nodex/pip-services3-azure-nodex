...
class AzureFunctionRequestSchema extends pip_services3_commons_nodex_2.ObjectSchema {
    constructor() {
        super();
        this.withRequiredProperty('req', new pip_services3_commons_nodex_2.ObjectSchema(true)
            .withOptionalProperty('body', pip_services3_commons_nodex_1.TypeCode.Map)
            .withOptionalProperty('query', pip_services3_commons_nodex_1.TypeCode.Map));
    }
}
