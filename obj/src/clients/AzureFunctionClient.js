    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this._client = null;
                throw new pip_services3_commons_nodex_1.ConnectionException(correlationId, "CANNOT_CONNECT", "Connection to Azure function service failed").wrap(err).withDetails("url", this._uri);
            }
        });
    }
    /**
